...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/empregabilidade/banco-curriculos": {
            "get": {
                ...
                "tags": [
                    "empregabilidade-banco-curriculos"
                ],
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/empregabilidade.BancoCurriculoListResponse"
                        }
                    },
                    "403": {
                        "description": "Forbidden",
        ...
        "/api/v1/empregabilidade/banco-curriculos/{cpf}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "CPF do cidadão, com ou sem máscara",
                        "name": "cpf",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/empregabilidade.BancoCurriculoDetalhe"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/empregabilidade/curriculo/areas-atuacao-habilidades": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/empregabilidade.CurriculoAreaAtuacaoHabilidade"
                            }
                        }
                    },
                    "401": {
                    ...
                    "500": {
                        "description": "Erro ao buscar áreas de atuação/habilidades do currículo",
                        "schema": {
                            "$ref": "#/definitions/response.ErrorResponse"
                        }
                    }
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "ID do vínculo entre área de atuação e habilidade",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/empregabilidade.AddAreaAtuacaoHabilidadeRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "500": {
                        "description": "Erro ao adicionar área de atuação/habilidade ao currículo",
                        "schema": {
                            "$ref": "#/definitions/response.ErrorResponse"
                        }
                    }
        ...
        "/api/v1/empregabilidade/curriculo/areas-atuacao-habilidades/{id}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "example": 10,
                        "description": "ID do vínculo (emp_curriculo_area_atuacao_habilidade)",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Erro ao remover área de atuação/habilidade do currículo",
                        "schema": {
                            "$ref": "#/definitions/response.ErrorResponse"
                        }
                    }
        ...
        "/api/v1/empregabilidade/habilidades/areas-atuacao-habilidades": {
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/empregabilidade.AreaAtuacaoHabilidade"
                            }
                        }
                    },
                    "500": {
                        "description": "Erro ao buscar áreas de atuação e habilidades",
                        "schema": {
                            "$ref": "#/definitions/response.ErrorResponse"
                        }
                    }
    ...
    "definitions": {
        ...
        "empregabilidade.AddAreaAtuacaoHabilidadeRequest": {
            "type": "object",
            "required": [
        ...
        "empregabilidade.AreaAtuacaoHabilidade": {
            "type": "object",
            "properties": {
                "area_atuacao": {
                    "$ref": "#/definitions/empregabilidade.AreaAtuacao"
        ...
        "empregabilidade.BancoCurriculoDetalhe": {
            "type": "object",
            "properties": {
                "bairro": {
                    "type": "string"
                ...
                "genero": {
                    "description": "Genero é a identidade de gênero autodeclarada. O sexo da base cadastral\nnão é usado como fallback.",
                    "type": "string"
                },
                "idade": {
                    "type": "integer"
        ...
        "empregabilidade.BancoCurriculoItem": {
            "type": "object",
            "properties": {
                "cpf": {
                    "type": "string"
        ...
        "empregabilidade.BancoCurriculoListMeta": {
            "type": "object",
            "properties": {
                "page": {
                    "type": "integer"
        ...
        "empregabilidade.BancoCurriculoListResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/empregabilidade.BancoCurriculoItem"
                    }
                },
                "meta": {
                    "$ref": "#/definitions/empregabilidade.BancoCurriculoListMeta"
                }
            }
        },
        ...
        "empregabilidade.CurriculoAreaAtuacaoHabilidade": {
            "type": "object",
            "properties": {
