...
func InitializeApplication(cfg *config.AppConfig) (*ApplicationContainer, error) {
	...
	empregoHandler := providers.ProvideEmpregoHandler(empregoService, rmiClient, serviceAccountTokenManager)
	...
	courseHandler := providers.ProvideCourseHandler(cursoService, inscricaoService, cursoRepository, courseCache, rmiClient, serviceAccountTokenManager)
