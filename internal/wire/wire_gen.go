...
func InitializeApplication(cfg *config.AppConfig) (*ApplicationContainer, error) {
	...
	candidaturaService := providers.ProvideEmpCandidaturaService(candidaturaRepository, vagaRepository, curriculoService, citizenSnapshotRepository, emailNotificationService)
