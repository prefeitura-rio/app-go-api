...
func (s *InscricaoService) validateScheduleID(_ context.Context, scheduleID uuid.UUID, curso *models.Curso, enforceWindow bool) error {
	...
	return enrollmentRuleErrorf("a turma selecionada não pertence a este curso")
}
